const localhost = 'http://192.168.1.52:8080/DeliveryFoodServices/rest';

const URL_LOGIN = localhost + '/UserService/users/login';
const URL_REGISTRY = localhost + '/UserService/users/registry';
const URL_UPDATE_USER = localhost + '/UserService/users/update';
const URL_TOPSELLER = localhost + '/ProductService/products/bestseller';
const URL_PRODUCTS = localhost + '/ProductService/products/';
